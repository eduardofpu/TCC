...
public abstract class GenericException extends RuntimeException {
	...
	public GenericException(ExceptionConstants exp, ExceptionParamBean... params) {
		this(exp.getMessage(), exp.getServerCode(), exp.getHttpStatus(), params);
	}

	public GenericException(String message, Integer serverCode, HttpStatus httpStatus, ExceptionParamBean... params) {
		super();
